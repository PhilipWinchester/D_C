...
# prints
Results <- Optimise(Match_Data, Max = 200)
...
# Teams
# 
# rem = c("Cardiff", "Fulham","Huddersfield","Stoke","Swansea","West Brom")
# 
...
#   # remove is a list of teams to remove
#   
#   # Findin the first gameweek in our predictions df
#   GWMin <- min(Predictions$GW)
#   
